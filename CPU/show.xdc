...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports {VALUE[6]}]
set_property -dict {PACKAGE_PIN N6 IOSTANDARD LVCMOS33} [get_ports {VALUE[7]}]
set_property -dict {PACKAGE_PIN R6 IOSTANDARD LVCMOS33} [get_ports {PUSH}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {POP}]
